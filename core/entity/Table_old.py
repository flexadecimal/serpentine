...
class BinaryBinder:
  ...
  def read(self):
    ...
    #equation_str = 'x+30+SIN(x*y)+INDEX()+CELL(2; TRUE)+INDEXES()'
    #equation_str = 'x+30+SIN(5)+ATAN(x*2)'
    #equation_str = 'POW(7*(x-5); 3)'
    equation_str = '(x+30+sin(30)+ROUND(2.0; 3) << 2) + IF(0xfe9 < 2; y; FALSE) + 2 ^ 6 >> (x+0xfe982)'
    #equation_str = 'x + 20 - 2 | 2 + (5^6) * 2 & (8*y !| 5) !& 6 + SIN(x) + IF(2 < z; 3; TRUE)'
